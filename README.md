...
<html lang="en">
  ...
  <body>
    ...
    <p style=" padding-left: 35em; height: 5em;"><button type="button" class="floating3 btn btn-danger btn-lg btn-circle a class="nav-link" href="Recipes.html">Recipes</button>
    </p>
